...
class PagerController : Controller() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup): View {
        ...
        @ColorRes val color = R.color.colorAccent
        ...
        ControllerRequestManager.with(this)
                ...
                .load(R.drawable.rsz_login_fashion)
                .into(object : ImageViewTarget<Bitmap>(background){
                    override fun setResource(resource: Bitmap?) {
                        ...
                        background.post{
                            ...
                            val xAnimator = ObjectAnimator.ofFloat(background, View.SCALE_X, 1f, 1f)
                            val yAnimator = ObjectAnimator.ofFloat(background, View.SCALE_Y, 1f, 1f)
